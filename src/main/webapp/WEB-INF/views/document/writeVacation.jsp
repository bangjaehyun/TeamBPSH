	...
	<div class="container">
        ...
        <div class="main-container">
            <form action="" method="post"  enctype="multipart/form-data">
                ...
                <div>
                    <label for="half">반차 신청 여부</label>
                    <input type="checkbox" id="half" name="halfDay">
                </div>

                <div class="half-time">
                    
                    <div><label for="am" style="background-color: white;border: none;"> 오전</label><input type="radio" name="select" value="am"></div>
                    <div><label for="pm" style="background-color: white;border: none;"> 오후</label><input type="radio" name="select" value="pm"></div>
                </div>

                <div class="set-date">
                    <div class="date">
                        <label for="vac-start">시작일자</label>
                        <input type="date" id="vacStart" name="start" max="9999-12-31" onchange="onDateChange()">
                    </div>
                    <div class="date" id="endDate">
                        <label for="vac-end">종료일자</label>
                        <input type="date" id="vacEnd" name="end" max="9999-12-31" onchange="totalDays()">
                    </div>
                    <div class="result">
                        <span>총 0일</span>
                    </div>
                ...
                <div>
                    ...
                    <div class="vac-content">
                        <textarea name="docContent" maxlength="600" placeholder="최대 600자까지 입력 가능합니다."></textarea>
                    </div>
                </div>
...
if (halfChecked) {
    document.getElementById('vacEnd').value = document.getElementById('vacStart').value;
...
function searchMan(e){
   ...
   let popup= window.open("","searchMan","width=" + popupWidth + ", height=" + popupHeight + ", top=" + top + ", left=" + left);
   
   let form=document.createElement('form');
   form.setAttribute("action","/doc/searchMan");
   form.setAttribute("method","post");
   form.setAttribute("type",e);
